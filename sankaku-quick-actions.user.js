...
// @name:en      Quick Actions for Sankaku
// @namespace    skq-quick-actions
// @version      1.35.0
// @description  Оценки и избранное прямо в ленте, горячие клавиши, массовая загрузка, правила скрытия постов и отключение рекламы на Sankaku Complex. Неофициальный.
// @description:en Rate and favorite posts right in the feed, hotkeys, bulk upload, post hiding rules and ad removal on Sankaku Complex. Unofficial.
// @author       MotoIlyuha
// @license      MIT
...
function core(storedSettings) {
  ...
  const STRINGS = /* SKQ_I18N_START */ {
    ...
    'pt': {
          ...
          "Теги": "Etiquetas",
          "Теги через запятую": "Etiquetas separadas por vírgulas",
    ...
    'sv': {
          ...
          "Теги": "Taggar",
          "Теги через запятую": "Taggar, kommaseparerade",
    ...
    'da': {
          ...
          "Теги": "Tags",
          "Теги через запятую": "Tags adskilt med komma",
          "Пользователь": "Bruger",
          "Видимость": "Synlighed",
          "Скрыть": "Skjul",
          "Размытие": "Slør",
    ...
    'no': {
          ...
          "Теги": "Tagger",
          "Теги через запятую": "Tagger, atskilt med komma",
          "Пользователь": "Bruker",
          "Видимость": "Synlighet",
          "Скрыть": "Skjul",
          "Размытие": "Uskarphet",
    ...
    'fi': {
          ...
          "Теги": "Tunnisteet",
          "Теги через запятую": "Tunnisteet pilkulla eroteltuina",
    ...
    'hu': {
          ...
          "Теги": "Címkék",
          "Теги через запятую": "Címkék vesszővel elválasztva",
    ...
    'ro': {
          ...
          "Теги": "Etichete",
          "Теги через запятую": "Etichete separate prin virgulă",
    ...
    'bg': {
          ...
          "Теги": "Тагове",
          "Теги через запятую": "Тагове, разделени със запетая",
    ...
    'el': {
          ...
          "Теги": "Ετικέτες",
          "Теги через запятую": "Ετικέτες, χωρισμένες με κόμμα",
    ...
    'tr': {
          ...
          "Теги": "Etiketler",
          "Теги через запятую": "Virgülle ayrılmış etiketler",
    ...
    'th': {
          ...
          "Теги": "แท็ก",
          "Теги через запятую": "แท็ก คั่นด้วยจุลภาค",
          "Пользователь": "ผู้ใช้",
    ...
    'hi': {
          ...
          "Теги": "टैग",
          "Теги через запятую": "टैग, अल्पविराम से अलग",
    ...
    'id': {
          ...
          "Теги": "Tag",
          "Теги через запятую": "Tag, dipisahkan koma",
